        ...
        <div className="bg-white rounded-lg w-full max-w-md p-6 relative">
          ...
          <div className="space-y-4">
            ...
            <label
              ...
              className="block w-full text-center px-4 py-2 bg-blue-800 text-white rounded-md hover:bg-blue-600 cursor-pointer"
            >
            ...
            <div className="flex justify-end space-x-4 mt-4">
              ...
              <button
                ...
                className="px-4 py-2 bg-blue-800 text-white rounded-md hover:bg-blue-600 disabled:opacity-50"
              >
