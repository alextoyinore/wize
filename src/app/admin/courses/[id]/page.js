              ...
              <div className="col-span-2">
                <div className="flex flex-col gap-4">
                  <button
                    ...
                    className="flex items-center justify-center border border-indigo-500 text-indigo-500 px-4 py-2 rounded-md hover:bg-indigo-50 hover:text-indigo-600 transition-colors"
                  >
