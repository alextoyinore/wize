        ...
        <form onSubmit={handleCreateCategory} className="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:blue-800"
                  ...
                  <td className="px-4 py-4 whitespace-nowrap">
                    {editingCategory?._id === category._id ? (
                      <textarea
                        ...
                        className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-800 min-h-[50px]"
                      />
                    ) : (
